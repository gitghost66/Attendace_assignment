...
Receives candidate experience + JD requirements → returns EvaluationResult.
"""
...
class ExperienceEvaluatorAgent:
    """
    Evaluates the quality and relevance of a candidate's work experience.

    Context provided: parsed experience entries + JD experience requirements.
    """
    ...
    def run(
        ...
        """
        Score the candidate's experience against the JD requirements.

        Args:
            resume_data: ParsedResume as dict (experience field is key).
            jd_data: ParsedJD as dict (experience_required, responsibilities).
